...
$(document).ready(function()
{
    ...
    //Controlador de multiples fotografias
    llenarControlFotos=function()
    {
        var html='';
        //Foto portada
        html+='<div class="col-sm-12" style="padding:1px">';
        html+='<div id="divFotoPortada" class="bloque-noticias" style="background:#30A5FF;">Agregar foto portada</div>';
        html+='</div>';

        html+='<div id="divMiniaturas"></div>';

        html+='<div class="col-sm-6" style="padding:1px">';
        html+='<div id="divAgregarFoto" class="bloque-noticias thumbnail" style="background:#9D9D9D;">+ Agregar foto</div>';
        html+='</div>';
        $("#divBloqueFotos").html(html);


        //Funciones de carga de imagen
        $(".imagen").change(function (e) {
            var tamano = this.files[0].size;
            if (parseInt(tamano) > 1000000) //2 MB
            {
        ...
        //Portada
        $("#divFotoPortada").click(function(event)
        {
        ...
        //Miniaturas
        $("#divAgregarFoto").click(function(event)
        {
            $("#fotosModal").modal('show');

            var html='<div class="col-sm-6" style="padding:1px">';
            html+='<div class="bloque-noticias thumbnail">Foto agregada</div>';
            html+='</div>';
            $("#divMiniaturas").append(html);
        });
    };
