...
@stop
@section('pie')
    <% HTML::script('https://maps.googleapis.com/maps/api/js?sensor=true&key=AIzaSyBGs-GHxr1V57gPV9VamdG4sWqNPM6qXww'); %>
    ...
    <% HTML::script('public/js/motoclublapaz/eventos.js'); %>
@stop
