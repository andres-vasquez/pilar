...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <p>
            ...
            <a class="btn btn-grande btn-success" href="#" id="btnSaldo" role="button">Ver mi saldo</a>
        </p>
    </div>
                    ...
                    <div class="col-xs-6 col-md-6">
                        <div class="panel panel-success" style="margin-left: 10px">
                            ...
                            <div class="panel-body">
                                ...
                                <br/><br/>
                                <strong class="pull-left">Costo por mensaje: <span id="txtGanancia"></span></strong>
                            </div>
